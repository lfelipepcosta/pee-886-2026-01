...
PARAMS_FILE = os.path.join(OUTPUT_DIR, "best_params_hybrid_6.json")
...
def optuna_objective(trial, X_train, y_train, X_val, y_val):
    ...
    params = {
        ...
        'n_qubits': trial.suggest_categorical('n_qubits', [6]), # Qubits fixados em 6 para testar a diferença
...
def main():
    ...
    '''
    print("Iniciando otimização TPE para modelos híbridos (6 qubits)")
    loader = DataLoader5G()
    ...
    study = optuna.create_study(direction="minimize", study_name="Hybrid_QML_Optimization_6")
    ...
    print("Otimização híbrida (6 qubits) concluída")
