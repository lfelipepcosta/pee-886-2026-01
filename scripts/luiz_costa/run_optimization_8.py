...
PARAMS_FILE = os.path.join(OUTPUT_DIR, "best_params_hybrid_8.json")
...
def optuna_objective(trial, X_train, y_train, X_val, y_val):
    ...
    params = {
        ...
        'n_qubits': trial.suggest_categorical('n_qubits', [8]), # Qubits fixados em 8 para testar a diferença
...
def main():
    ...
    '''
    print("Iniciando otimização TPE para modelos híbridos (8 qubits)")
    loader = DataLoader5G()
    ...
    study = optuna.create_study(direction="minimize", study_name="Hybrid_QML_Optimization_8")
    ...
    print("Otimização híbrida (8 qubits) concluída")
