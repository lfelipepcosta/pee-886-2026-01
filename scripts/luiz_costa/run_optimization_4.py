...
PARAMS_FILE = os.path.join(OUTPUT_DIR, "best_params_hybrid_4.json")
...
def main():
    ...
    '''
    print("Iniciando otimização TPE para modelos híbridos (4 qubits)")
    loader = DataLoader5G()
    ...
    study = optuna.create_study(direction="minimize", study_name="Hybrid_QML_Optimization_4")
    ...
    print("Otimização híbrida (4 qubits) concluída")
